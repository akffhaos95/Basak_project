...
<script>
	$(document).ready(function(){
		$('#btnLogin').click(function(){
			document.login_form.action = "/member/login"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="login_form" method="post">
					...
					<br>
					<div class="form-group">
						<button type="submit" id="btnLogin" class="btn btn-secondary btn-block btn-lg">Login</button>
					</div>
				</form>
			</div>
		</div>

...
<script>
	$(document).ready(function(){
		$("#btnWrite").click(function(){
			document.write_form.action = "/member/writeCheck.do"
				...
				<form name="write_form" method="post">
					...
					<div class="form-group">
						<div class="input-group">
							...
							<input type="text" class="form-control" id="memberMail" name="memberMail" placeholder="Mail Address" required="required">
						</div>
					</div>
					<br>
					<c:if test="${write_msg=='failure'}">
						<div style="color: red;">
							이미 같은 아이디가 있습니다
						</div>
					</c:if>
					<br>
					<div class="form-group">
						<button type="submit" id="btnWrite" class="btn btn-secondary btn-block btn-lg">회원가입</button>
					</div>
				</form>
			</div>
		</div>
